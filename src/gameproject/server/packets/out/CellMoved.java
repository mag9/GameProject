 ...
 */
public class CellMoved implements PacketCreator
{
    ...
    public void write(OutgoingPacket packet, Object... parameters)
    {
        ...
        packet.writeWord((int)cell.getCircle().getX());
        packet.writeWord((int)cell.getCircle().getY());
        packet.writeWord((int)cell.getCircle().getRadius());
    }
